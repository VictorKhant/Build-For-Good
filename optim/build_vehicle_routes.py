...
def arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--method", choices=["greedy", "optimized"], default="optimized")
...
def main() -> None:
    args = arguments()
    allocation_table = f"simulation_{'baseline' if args.method == 'greedy' else 'optimized'}_allocations"
